...
def add_rl_args(p: ArgumentParser):
    ...
    p.add_argument("--fear", default=0, type=float, help="Intrinsic fear")
    p.add_argument("--fear_radius", default=0, type=float, help="Radius of fear for the fear reward shaping")
    p.add_argument("--fear_penalty", default=0, type=float, help="Penalty for being in the fear radius")
    p.add_argument("--violation_penalty",
                   default=0,
                   type=float,
                   help="Penalty for incurring safety violation")
    p.add_argument(
        "--noise_mult",
        default=0,
        type=float,
        help="Multiplier for gaussian noise. 0=Off"
    )
    p.add_argument(
        "--load_optimizer",
        default=False,
        type=bool,
        help="Whether to load the optimizer during transfer learning."
    )
    p.add_argument(
        "--num_policies",
        default=1,
