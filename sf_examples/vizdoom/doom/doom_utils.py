...
from sf_examples.vizdoom.doom.wrappers.reward_shaping import (
    ...
    REWARD_SHAPING_SAFERL,
    REWARD_SHAPING_SAFERL_DAMAGE,
...
SAFERL_REWARD_SHAPING = (
    DoomRewardShapingWrapper,
    dict(reward_shaping_scheme=REWARD_SHAPING_SAFERL, true_objective_func=None),
)

SAFERL_REWARD_SHAPING_DAMAGE = (
    DoomRewardShapingWrapper,
    dict(reward_shaping_scheme=REWARD_SHAPING_SAFERL_DAMAGE, true_objective_func=None),
)
...
DOOM_ENVS = [
    ...
    DoomSpec (
        ...
        doom_action_space_extended(),
        1.0,
        extra_wrappers=[SAFERL_REWARD_SHAPING]),
    DoomSpec (
        "safe_rl_transfer",
        'facing_other_way.cfg',
        doom_action_space_extended(),
        1.0,
        extra_wrappers=[SAFERL_REWARD_SHAPING]),
    DoomSpec (
        ...
        doom_action_space_extended(),
        1.0,
        extra_wrappers=[SAFERL_REWARD_SHAPING_DAMAGE]),
    DoomSpec(
        "doom_dwango5",
        "dwango5_dm.cfg",
        doom_action_space(),
    ...
    **kwargs,
    ...
    if player_id is None:
        env = VizdoomEnv(
            ...
            prefix=cfg.prefix,
            main_level=cfg.main_level,
            trial=cfg.trial,
            penalty_violation=cfg.violation_penalty,
            fear=cfg.fear,
            fear_penalty=cfg.fear_penalty,
